...
export const getRequiredNamespaces = (
  ...
  logger.info("[namespaces,getRequiredNamespaces]", "selected required namespaces:", selectedNamespaces);
...
export const getOptionalNamespaces = (
  ...
  const selectedNamespaces = getNamespacesFromChains(chains);
  logger.info(
    "[namespaces,getOptionalNamespaces]",
    "selected optional namespaces:",
    selectedNamespaces,
  );
